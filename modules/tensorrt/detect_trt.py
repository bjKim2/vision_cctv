...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # Inference
        bindings = getBindings(model,context,(1,3,imgsz,imgsz))
        ...
        if nms_switch:
            ...
            out = non_max_suppression(out, conf_thres=opt.conf_thres, iou_thres=opt.iou_thres, labels=opt.classes, multi_label=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolov7_w6_crowdhuman_epoch852_size1280.trt', help='model.pt path(s)')

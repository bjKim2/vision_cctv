...
class LoadImagesAndLabels(Dataset):  # for training/testing
        ...
        if self.rect:
            ...
            for i in range(nb):
                ...
                if maxi < 1:
                    ...
                    shapes[i] = [1, 1 / mini]
            print(f' shapes, img_size , stride , pad : {shapes}, {img_size},{stride} , {pad}')
            ...
            try:
                ...
                if os.path.isfile(lb_file):
                    ...
                    if len(l):
                        ...
                        #inserted code
                        assert 1==2,'empty label'
                        ne += 1  # label empty
                        l = np.zeros((0, 5), dtype=np.float32)
                else:
                    #inserted code
                    assert 1==2,'missing label'
                    nm += 1  # label missing
    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            ...
            # print('batch_shapes , img_size : ',self.batch_shapes ,self.img_size )
            # print('&& shape',shape)
        ...
        img = img[:, :, ::-1].transpose(2, 0, 1)  # BGR to RGB, to 3x416x416
        img = np.ascontiguousarray(img)
        # print('return img.shape',img.shape)
...
def letterbox(img, new_shape=(640, 640), color=(114, 114, 114), auto=True, scaleFill=False, scaleup=True, stride=32):
    ...
    # print('r, new_shape,new_unpad',r,new_shape,new_unpad)
    dw, dh = new_shape[1] - new_unpad[0], new_shape[0] - new_unpad[1]  # wh padding
    # print('1st dw,dh',dw,dh)

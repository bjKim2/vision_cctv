...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
                      rank=-1, world_size=1, workers=8, image_weights=False, quad=False, prefix='',trt = False):
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
                 cache_images=False, single_cls=False, stride=32, pad=0.0, prefix='',trt = False):
        self.img_size = img_size
    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            ...
            if self.trt: 
                ...
                shapes = (h0, w0), ((self.img_size / h0, self.img_size / w0), pad)
                img = np.ascontiguousarray(img)
    ...
    def collate_fn4(batch):
        ...
        return torch.stack(img4, 0), torch.cat(label4, 0), path4, shapes

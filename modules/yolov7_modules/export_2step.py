...
from export_dynamic import EngineBuilder, EngineCalibrator, main
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./yolov7.pt', help = '.pt file name for converting to trt file')
    parser.add_argument('--img-size', nargs= '+' ,type = int, default = [640, 640], help='image size')
    parser.add_argument('--batch-size', type = int, default=1, help= 'batch size if not dynamic-batch')
    ...
    # start
    # parser = argparse.ArgumentParser()
    # parser.add_argument("-o", "--onnx", default=f, help="The input ONNX model file to load")
    # parser.add_argument("-e", "--engine",default=f[:-4] +'trt' ,help="The output path for the TRT engine")
    ...
    # # parser.add_argument("-d", "--dynamic_batch_size", type=str, default='1,16,32',
